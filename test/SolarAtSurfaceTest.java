...
class SolarAtSurfaceTest {
  ...
  void returnsUndefinedIfAnyInputComponentIsUndefined () {
    float result = app.SolarAtSurface(
  ...
  void sunAlignedWithAnUpwardSurfaceGivesFullDirectPlusFullSky () {
    ...
    float result = app.SolarAtSurface(0, 0, 1, 800, 100, 90, 0, 0);
  ...
  void skyMaskIsHalfAtAlphaZeroWithNoDirectContribution () {
    ...
    // Alpha=0) contributes.
    float result = app.SolarAtSurface(0, 0, 1, 999, 100, 0, 90, 0);
  ...
  void regularBranchMatchesTheTrigFormulaAtA45DegreeTilt () {
    ...
    float result = app.SolarAtSurface(0, -1, 1, 1000, 200, 45, 0, 0);
  ...
  void negativeAlphaBranchIsNowReachableAndUsesTheDownwardVector () {
    ...
    float aligned = app.SolarAtSurface(0, 0, -1, 800, 100, -90, 0, 0);
    ...
    float opposite = app.SolarAtSurface(0, 0, 1, 800, 100, -90, 0, 0);
