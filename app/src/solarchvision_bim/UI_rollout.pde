class UI_rollout {
  ...
  int valueModifier_Number_of_days_to_plot (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 1, 0, "Number of days to plot", STUDY.j_End, 1, 365, 1);
    }
    return out;
  }
  ...
  float valueModifier_Day_step (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 1, 0, "Day step", STUDY.perDays, 1.0, 182.5, 0.5);
    }
    return out;
  }
  ...
  int valueModifier_Join_days (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 1, 0, "Join days", STUDY.joinDays, 1, 182, 1);
    }
    return out;
  }
  ...
  float valueModifier_Days_past_March_equinox (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 1, 0, "Days past March equinox", TIME.date, 0, 364, 1);
    }
    return out;
  }
  ...
  int valueModifier_Begin_day (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 1, 0, "Begin day", TIME.day, 1, 31, 1);
    }
    return out;
  }
  ...
  int valueModifier_Begin_month (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 1, 0, "Begin month", TIME.month, 1, 12, 1);
    }
    return out;
  }
  ...
  int valueModifier_Begin_year (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 1, 0, "Begin year", TIME.year, 1953, 2100, 1);
    }
    return out;
  }
  ...
  int valueModifier_Start_hour (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Start hour", STUDY.i_Start, 0, 23, 1);
    }
    return out;
  }
  ...
  int valueModifier_End_hour (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "End hour", STUDY.i_End, 0, 23, 1);
    }
    return out;
  }
  ...
  int valueModifier_Start_year (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Start year", SampleYear_Start, CLIMATE_CWEEDS_start, CLIMATE_CLMREC_end, 1);
    }
    return out;
  }
  ...
  int valueModifier_End_year (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "End year", SampleYear_End, CLIMATE_CWEEDS_start, CLIMATE_CLMREC_end, 1);
    }
    return out;
  }
  ...
  int valueModifier_Start_member (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Start member", SampleMember_Start, ENSEMBLE_FORECAST_start, ENSEMBLE_FORECAST_end, 1);
    }
    return out;
  }
  ...
  int valueModifier_End_member (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "End member", SampleMember_End, ENSEMBLE_FORECAST_start, ENSEMBLE_FORECAST_end, 1);
    }
    return out;
  }
  ...
  int valueModifier_Start_station (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Start station", SampleStation_Start, ENSEMBLE_OBSERVED_start, ENSEMBLE_OBSERVED_end, 1);
    }
    return out;
  }
  ...
  int valueModifier_End_station (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "End station", SampleStation_End, ENSEMBLE_OBSERVED_start, ENSEMBLE_OBSERVED_end, 1);
    }
    return out;
  }
  ...
  int valueModifier_Forecast_Obs_maxDays (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "Forecast/Obs_maxDays", ENSEMBLE_OBSERVED_maxDays, 0, 31, 1);
    }
    return out;
  }
  ...
  int valueModifier_Sky_status (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Sky status", STUDY.skyScenario, 1, 4, 1);
    }
    return out;
  }
  ...
  int valueModifier_Hourly_daily_filter (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Hourly/daily filter", STUDY.filter, 0, 1, 1);
    }
    return out;
  }
  ...
  float valueModifier_Latitude (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "Latitude", LocationLAT, -85, 85, 0.01);
    }
    return out;
  }
  ...
  float valueModifier_Longitude (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "Longitude", LocationLON, -180, 180, 0.01);
    }
    return out;
  }
  ...
  int valueModifier_displayAll_TMYEPW (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayAll_TMYEPW", WORLD.displayAll_TMYEPW, 0, 2, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_displayNear_TMYEPW (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayNear_TMYEPW", WORLD.displayNear_TMYEPW);
    }
    return out;
  }
  ...
  int valueModifier_displayAll_CWEEDS (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayAll_CWEEDS", WORLD.displayAll_CWEEDS, 0, 2, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_displayNear_CWEEDS (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayNear_CWEEDS", WORLD.displayNear_CWEEDS);
    }
    return out;
  }
  ...
  int valueModifier_displayAll_CLMREC (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayAll_CLMREC", WORLD.displayAll_CLMREC, 0, 2, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_displayNear_CLMREC (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayNear_CLMREC", WORLD.displayNear_CLMREC);
    }
    return out;
  }
  ...
  int valueModifier_displayAll_SWOB (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayAll_SWOB", WORLD.displayAll_SWOB, 0, 2, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_displayNear_SWOB (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayNear_SWOB", WORLD.displayNear_SWOB);
    }
    return out;
  }
  ...
  int valueModifier_displayAll_NAEFS (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayAll_NAEFS", WORLD.displayAll_NAEFS, 0, 2, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_displayNear_NAEFS (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 1, "displayNear_NAEFS", WORLD.displayNear_NAEFS);
    }
    return out;
  }
  ...
  boolean valueModifier_addToLastGroup (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "addToLastGroup", addToLastGroup);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Material (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Material", User3D.default_Material, -1, 8, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Tessellation (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Tessellation", User3D.default_Tessellation, 0, 6, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Layer (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Layer", User3D.default_Layer, 0, 16, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Visibility (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Visibility", User3D.default_Visibility, -1, 1, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Weight (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0,0,0, "3D-create.Weight" , User3D.default_Weight, -20, 20, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Closed (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0,0,0, "3D-create.Closed" , User3D.default_Closed, 0, 1, 1);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_Orientation (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Orientation", User3D.create_Orientation, 0, 360, 1, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_Length_rand_negative (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Length (rand negative)", User3D.create_Length, -100.0, 1000.0, 1.0, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_Width_rand_negative (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Width (rand negative)", User3D.create_Width, -100.0, 1000.0, 1.0, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_Height_rand_negative (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Height (rand negative)", User3D.create_Height, -100.0, 1000.0, 1.0, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_Volume (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Volume", User3D.create_Volume, 0, 1000000000, 1, 0.001);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Snap (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Snap", User3D.create_Snap, 0, 1, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_SphereDegree (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.SphereDegree", User3D.create_SphereDegree, 0, 5, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_CylinderDegree (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.CylinderDegree", User3D.create_CylinderDegree, 3, 36, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_PolyDegree (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.PolyDegree", User3D.create_PolyDegree, 3, 36, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Parametric_Type (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Parametric_Type", User3D.create_Parametric_Type, 1, 6, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Person_Type (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Person_Type", User3D.create_Person_Type, 0, allModel2Ds.num_files_PEOPLE, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Plant_Type (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Plant_Type", User3D.create_Plant_Type, 0, allModel2Ds.num_files_TREES, 1);
    }
    return out;
  }
  ...
  float valueModifier__3D_modify_OpenningDepth (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-modify.OpenningDepth", User3D.modify_OpenningDepth, -10, 10, 0.1);
    }
    return out;
  }
  ...
  float valueModifier__3D_modify_OpenningArea (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-modify.OpenningArea", User3D.modify_OpenningArea, 0, 1, 0.05);
    }
    return out;
  }
  ...
  float valueModifier__3D_modify_OpenningDeviation (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-modify.OpenningDeviation", User3D.modify_OpenningDeviation, 0, 1, 0.05);
    }
    return out;
  }
  ...
  int valueModifier__3D_modify_TessellateRows (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-modify.TessellateRows", User3D.modify_TessellateRows, 1, 100, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_modify_TessellateColumns (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-modify.TessellateColumns", User3D.modify_TessellateColumns, 1, 100, 1);
    }
    return out;
  }
  ...
  float valueModifier__3D_modify_OffsetAmount (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-modify.OffsetAmount", User3D.modify_OffsetAmount, 0, 25, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_modify_WeldTreshold (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-modify.WeldTreshold", User3D.modify_WeldTreshold, 0, 10, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_select_softPower (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.softPower", Select3D.softPower, 0.125, 8.0, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_select_softRadius (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.softRadius", Select3D.softRadius, 0.01, 100, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier__3D_select_posVector (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.posVector", Select3D.posVector, 0, 3, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_select_rotVector (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.rotVector", Select3D.rotVector, 0, 2, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_select_scaleVector (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.scaleVector", Select3D.scaleVector, 0, 3, 1);
    }
    return out;
  }
  ...
  float valueModifier__3D_select_posValue (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.posValue", Select3D.posValue, -50.0, 50.0, 1.0, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_select_rotValue (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.rotValue", Select3D.rotValue, -180.0, 180.0, 1.0, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_select_scaleValue (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.scaleValue", Select3D.scaleValue, -8.0, 8.0, 1.0, 0.001);
    }
    return out;
  }
  ...
  int valueModifier__3D_select_alignX (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.alignX", Select3D.alignX, -1, 1, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_select_alignY (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.alignY", Select3D.alignY, -1, 1, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_select_alignZ (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.alignZ", Select3D.alignZ, -1, 1, 1);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_powAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.powAll", User3D.create_powAll, 0.5, CubePower, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_powX (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.powX", User3D.create_powX, 0.5, CubePower, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_powY (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.powY", User3D.create_powY, 0.5, CubePower, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_powZ (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.powZ", User3D.create_powZ, 0.5, CubePower, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Type (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Type", User3D.create_Model1D_Type, 0, 0, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_DegreeMax (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.DegreeMax", User3D.create_Model1D_DegreeMax, 0, 12, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_Seed (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.Seed", User3D.create_Model1D_Seed, -1, 32767, 1);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_TrunkSize (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.TrunkSize", User3D.create_Model1D_TrunkSize, 0, 10, 0.1, 0.1);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_LeafSize (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.LeafSize", User3D.create_Model1D_LeafSize, 0, 1, 0.01, 0.1);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_BranchTilt (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.BranchTilt", User3D.create_Model1D_BranchTilt, 0, 360, 5, 0.1);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_BranchTwist (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.BranchTwist", User3D.create_Model1D_BranchTwist, 0, 360, 5, 0.1);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_BranchRatio (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.BranchRatio", User3D.create_Model1D_BranchRatio, 0.05, 1, 0.05, 0.01);
    }
    return out;
  }
  ...
  float valueModifier__3D_create_TreeBase (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-create.TreeBase", User3D.create_Model1D_TreeBase, 0, 4, 0.1, 0.01);
    }
    return out;
  }
  ...
  boolean valueModifier_Land3D_loadTextures (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.loadTextures", Land3D.loadTextures);
    }
    return out;
  }
  ...
  boolean valueModifier_Land3D_loadMesh (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.loadMesh", Land3D.loadMesh);
    }
    return out;
  }
  ...
  int valueModifier_Land3D_skipStart (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.skipStart", Land3D.skipStart, 0, Land3D.num_rows - 1, 1);
    }
    return out;
  }
  ...
  int valueModifier_Land3D_skipEnd (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.skipEnd", Land3D.skipEnd, 0, Land3D.num_rows - 1, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_Land3D_displaySurface (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.displaySurface", Land3D.displaySurface);
    }
    return out;
  }
  ...
  boolean valueModifier_Land3D_displayTexture (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.displayTexture", Land3D.displayTexture);
    }
    return out;
  }
  ...
  boolean valueModifier_Land3D_displayPoints (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.displayPoints", Land3D.displayPoints);
    }
    return out;
  }
  ...
  boolean valueModifier_Land3D_displayDepth (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.displayDepth", Land3D.displayDepth);
    }
    return out;
  }
  ...
  boolean valueModifier_model2Ds_displayAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "model2Ds.displayAll", allModel2Ds.displayAll);
    }
    return out;
  }
  ...
  boolean valueModifier_model1Ds_displayAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "model1Ds.displayAll", allModel1Ds.displayAll);
    }
    return out;
  }
  ...
  boolean valueModifier_model1Ds_displayLeaves (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "model1Ds.displayLeaves", allModel1Ds.displayLeaves);
    }
    return out;
  }
  ...
  boolean valueModifier_polylines_displayAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "polylines.displayAll", allPolylines.displayAll);
    }
    return out;
  }
  ...
  boolean valueModifier_faces_displayAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "faces.displayAll", allFaces.displayAll);
    }
    return out;
  }
  ...
  boolean valueModifier_solids_displayAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solids.displayAll", allSolids.displayAll);
    }
    return out;
  }
  ...
  boolean valueModifier_sections_displayAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "sections.displayAll", allSections.displayAll);
    }
    return out;
  }
  ...
  boolean valueModifier_windRoses_displayImage (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "windRoses.displayImage", allWindRoses.displayImage);
    }
    return out;
  }
  ...
  float valueModifier_windRoses_scale (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "windRoses.scale", allWindRoses.scale, 50, 3200, -2, 0.001);
    }
    return out;
  }
  ...
  boolean valueModifier_Sky3D_displaySurface (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky3D.displaySurface", Sky3D.displaySurface);
    }
    return out;
  }
  ...
  boolean valueModifier_Sun3D_displayPath (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.displayPath", Sun3D.displayPath);
    }
    return out;
  }
  ...
  boolean valueModifier_Sun3D_displayPattern (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.displayPattern", Sun3D.displayPattern);
    }
    return out;
  }
  ...
  int valueModifier_currentCamera (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "currentCamera", WIN3D.currentCamera, 0, allCameras.num, 1);
    }
    return out;
  }
  ...
  float valueModifier_Camera_clipNear (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Camera_clipNear", WIN3D.CAM_clipNear, 0.01, 100, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_Camera_clipFar (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Camera_clipFar", WIN3D.CAM_clipFar, 1000, 2000000000, -2, 0.001);
    }
    return out;
  }
  ...
  boolean valueModifier_Create3D_displayVertices (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Create3D.displayVertices", allPoints.displayAll);
    }
    return out;
  }
  ...
  boolean valueModifier_Create3D_displayEdges (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Create3D.displayEdges", allFaces.displayEdges);
    }
    return out;
  }
  ...
  boolean valueModifier_Create3D_displayNormals (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Create3D.displayNormals", allFaces.displayNormals);
    }
    return out;
  }
  ...
  boolean valueModifier_cameras_displayAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "cameras.displayAll", allCameras.displayAll);
    }
    return out;
  }
  ...
  int valueModifier_IMPACTS_displayDay (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "IMPACTS_displayDay", IMPACTS_displayDay, 0, STUDY.j_End - STUDY.j_Start, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_solarImpacts_displayImage (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solarImpacts.displayImage", allSolarImpacts.displayImage);
    }
    return out;
  }
  ...
  boolean valueModifier_solidImpacts_displayImage (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.displayImage", allSolidImpacts.displayImage);
    }
    return out;
  }
  ...
  int valueModifier_solarImpacts_sectionType (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solarImpacts.sectionType", allSolarImpacts.sectionType, 0, 3, 1);
    }
    return out;
  }
  ...
  int valueModifier_solidImpacts_sectionType (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.sectionType", allSolidImpacts.sectionType, 0, 3, 1);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_Grade (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.Grade", allSolidImpacts.Grade, 0.0001, 64.0, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_Power (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.Power", allSolidImpacts.Power, 0.0001, 64.0, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_R (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.R[" + nf(allSolidImpacts.sectionType, 0) + "]", allSolidImpacts.R[allSolidImpacts.sectionType], -360, 360, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_Z (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.Z[" + nf(allSolidImpacts.sectionType, 0) + "]", allSolidImpacts.Z[allSolidImpacts.sectionType], -1000, 1000, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_positionStep (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.positionStep", allSolidImpacts.positionStep, 5, 80, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_U (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.U[" + nf(allSolidImpacts.sectionType, 0) + "]", allSolidImpacts.U[allSolidImpacts.sectionType], 0.125, 3200, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_V (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.V[" + nf(allSolidImpacts.sectionType, 0) + "]", allSolidImpacts.V[allSolidImpacts.sectionType], 0.125, 3200, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_X (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.X[" + nf(allSolidImpacts.sectionType, 0) + "]", allSolidImpacts.X[allSolidImpacts.sectionType], -10000, 10000, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_Y (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.Y[" + nf(allSolidImpacts.sectionType, 0) + "]", allSolidImpacts.Y[allSolidImpacts.sectionType], -10000, 10000, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_WindSpeed_m_s (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.WindSpeed (m/s)", allSolidImpacts.WindSpeed, 1, 16, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_solidImpacts_WindDirection (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solidImpacts.WindDirection", allSolidImpacts.WindDirection, 0, 360, 15);
    }
    return out;
  }
  ...
  int valueModifier_solidImpacts_Process_subDivisions (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "solidImpacts.Process_subDivisions", allSolidImpacts.Process_subDivisions, 0, 3, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_solidImpacts_displayPoints (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "solidImpacts.displayPoints", allSolidImpacts.displayPoints);
    }
    return out;
  }
  ...
  boolean valueModifier_solidImpacts_displayLines (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "solidImpacts.displayLines", allSolidImpacts.displayLines);
    }
    return out;
  }
  ...
  boolean valueModifier_windFlows_displayAll (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "windFlows.displayAll", allWindFlows.displayAll);
    }
    return out;
  }
  ...
  int valueModifier__3D_create_displayTessellation (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "3D-create.displayTessellation", allFaces.displayTessellation, 0, 4, 1);
    }
    return out;
  }
  ...
  int valueModifier_Land_displayTessellation (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land.displayTessellation", Land3D.displayTessellation, 0, 4, 1);
    }
    return out;
  }
  ...
  int valueModifier_Sky_displayTessellation (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky.displayTessellation", Sky3D.displayTessellation, 0, 4, 1);
    }
    return out;
  }
  ...
  float valueModifier_Sky_scale (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky.scale",   Sky3D.radius, 1, 4000000, -2, 0.001);
    }
    return out;
  }
  ...
  boolean valueModifier_Tropo3D_displaySurface (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Tropo3D.displaySurface", Tropo3D.displaySurface);
    }
    return out;
  }
  ...
  boolean valueModifier_Tropo3D_displayTexture (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Tropo3D.displayTexture", Tropo3D.displayTexture);
    }
    return out;
  }
  ...
  boolean valueModifier_Earth3D_displaySurface (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Earth3D.displaySurface", Earth3D.displaySurface);
    }
    return out;
  }
  ...
  boolean valueModifier_Earth3D_displayTexture (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Earth3D.displayTexture", Earth3D.displayTexture);
    }
    return out;
  }
  ...
  float valueModifier_Earth3D_levelOfDetail (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Earth3D.levelOfDetail", Earth3D.levelOfDetail, 1.0 / 16.0, 16.0, -2, 0.001);
    }
    return out;
  }
  ...
  boolean valueModifier_Moon3D_displaySurface (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Moon3D.displaySurface", Moon3D.displaySurface);
    }
    return out;
  }
  ...
  boolean valueModifier_Moon3D_displayTexture (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Moon3D.displayTexture", Moon3D.displayTexture);
    }
    return out;
  }
  ...
  boolean valueModifier_Moon3D_fitInSkyDome (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Moon3D.fitInSkyDome", Moon3D.fitInSkyDome);
    }
    return out;
  }
  ...
  boolean valueModifier_Sun3D_displaySurface (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.displaySurface", Sun3D.displaySurface);
    }
    return out;
  }
  ...
  boolean valueModifier_Sun3D_displayTexture (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.displayTexture", Sun3D.displayTexture);
    }
    return out;
  }
  ...
  boolean valueModifier_Sun3D_fitInSkyDome (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.fitInSkyDome", Sun3D.fitInSkyDome);
    }
    return out;
  }
  ...
  float valueModifier_Planetary_Magnification (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Planetary_Magnification", Planetary_Magnification, 1, 64, -2);
    }
    return out;
  }
  ...
  float valueModifier_Objects_scale (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Objects_scale", OBJECTS_scale, 0.0000001, 1000000, -2, 0.000001);
    }
    return out;
  }
  ...
  int valueModifier_Diagram_setup (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Diagram setup", STUDY.plotSetup, -2, 8, 1);
    }
    return out;
  }
  ...
  float valueModifier_Scale (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Scale (" + allLayers[CurrentLayer_id].descriptions[Language_EN] + ")", STUDY.V_scale, 0.0001, 10000, -pow(2.0, (1.0 / 2.0)));
    }
    return out;
  }
  ...
  boolean valueModifier_Draw_data (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Draw data", STUDY.displayRaws);
    }
    return out;
  }
  ...
  boolean valueModifier_Draw_sorted (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Draw sorted", STUDY.displaySorted);
    }
    return out;
  }
  ...
  boolean valueModifier_Draw_statistics (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Draw statistics", STUDY.displayNormals);
    }
    return out;
  }
  ...
  boolean valueModifier_Draw_probabilities (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Draw probabilities", STUDY.displayProbs);
    }
    return out;
  }
  ...
  int valueModifier_Probabilities_interval (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Probabilities interval", STUDY.sumInterval, 1, 24, 1);
    }
    return out;
  }
  ...
  float valueModifier_Probabilities_range (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Probabilities range", STUDY.LevelPix, 2, 32, -2, 1);
    }
    return out;
  }
  ...
  int valueModifier_STUDY_ACTIVE_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.ACTIVE_palette_CLR", STUDY.ACTIVE_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_STUDY_ACTIVE_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.ACTIVE_palette_DIR", STUDY.ACTIVE_palette_DIR, -2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_STUDY_ACTIVE_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.ACTIVE_palette_MLT", STUDY.ACTIVE_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_STUDY_PASSIVE_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.PASSIVE_palette_CLR", STUDY.PASSIVE_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_STUDY_PASSIVE_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.PASSIVE_palette_DIR", STUDY.PASSIVE_palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_STUDY_PASSIVE_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.PASSIVE_palette_MLT", STUDY.PASSIVE_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_STUDY_SORT_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.SORT_palette_CLR", STUDY.SORT_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_STUDY_SORT_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.SORT_palette_DIR", STUDY.SORT_palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_STUDY_SORT_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.SORT_palette_MLT", STUDY.SORT_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_STUDY_PROB_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.PROB_palette_CLR", STUDY.PROB_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_STUDY_PROB_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.PROB_palette_DIR", STUDY.PROB_palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_STUDY_PROB_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "STUDY.PROB_palette_MLT", STUDY.PROB_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  float valueModifier_Windose_opacity_scale (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Windose opacity scale", STUDY.O_scale, 1, 100, -pow(2.0, (1.0 / 4.0)));
    }
    return out;
  }
  ...
  int valueModifier_faces_ACTIVE_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "faces.ACTIVE_palette_CLR", allFaces.ACTIVE_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_faces_ACTIVE_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "faces.ACTIVE_palette_DIR", allFaces.ACTIVE_palette_DIR, -2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_faces_ACTIVE_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "faces.ACTIVE_palette_MLT", allFaces.ACTIVE_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_faces_PASSIVE_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "faces.PASSIVE_palette_CLR", allFaces.PASSIVE_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_faces_PASSIVE_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "faces.PASSIVE_palette_DIR", allFaces.PASSIVE_palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_faces_PASSIVE_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "faces.PASSIVE_palette_MLT", allFaces.PASSIVE_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_Sky3D_ACTIVE_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky3D.ACTIVE_palette_CLR", Sky3D.ACTIVE_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_Sky3D_ACTIVE_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky3D.ACTIVE_palette_DIR", Sky3D.ACTIVE_palette_DIR, -2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_Sky3D_ACTIVE_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky3D.ACTIVE_palette_MLT", Sky3D.ACTIVE_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_Sky3D_PASSIVE_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky3D.PASSIVE_palette_CLR", Sky3D.PASSIVE_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_Sky3D_PASSIVE_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky3D.PASSIVE_palette_DIR", Sky3D.PASSIVE_palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_Sky3D_PASSIVE_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sky3D.PASSIVE_palette_MLT", Sky3D.PASSIVE_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_Sun3D_ACTIVE_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.ACTIVE_palette_CLR", Sun3D.ACTIVE_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_Sun3D_ACTIVE_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.ACTIVE_palette_DIR", Sun3D.ACTIVE_palette_DIR, -2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_Sun3D_ACTIVE_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.ACTIVE_palette_MLT", Sun3D.ACTIVE_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_Sun3D_PASSIVE_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.PASSIVE_palette_CLR", Sun3D.PASSIVE_palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_Sun3D_PASSIVE_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.PASSIVE_palette_DIR", Sun3D.PASSIVE_palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_Sun3D_PASSIVE_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Sun3D.PASSIVE_palette_MLT", Sun3D.PASSIVE_palette_MLT, 0.125, 8, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_solids_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solids.palette_CLR", allSolids.palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_solids_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solids.palette_DIR", allSolids.palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_solids_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "solids.palette_MLT", allSolids.palette_MLT, 0.0001, 64, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_Land3D_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.palette_CLR", Land3D.palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_Land3D_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.palette_DIR", Land3D.palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_Land3D_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "Land3D.palette_MLT", Land3D.palette_MLT, 0.001, 0.5, -2, 0.001);
    }
    return out;
  }
  ...
  int valueModifier_windFlows_palette_CLR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "windFlows.palette_CLR", allWindFlows.palette_CLR, -1, (COLOR_STYLE_Number - 1), 1);
    }
    return out;
  }
  ...
  int valueModifier_windFlows_palette_DIR (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "windFlows.palette_DIR", allWindFlows.palette_DIR, -2, 2, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_windFlows_palette_MLT (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 1, 0, "windFlows.palette_MLT", allWindFlows.palette_MLT, 0.01, 1.0, -2, 0.001);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Group_displayPivot (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Group_displayPivot", Select3D.Group_displayPivot);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_displayReferencePivot (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.displayReferencePivot", Select3D.displayReferencePivot);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Group_displayBox (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Group_displayBox", Select3D.Group_displayBox);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Group_displayEdges (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Group_displayEdges", Select3D.Group_displayEdges);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Face_displayEdges (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Face_displayEdges", Select3D.Face_displayEdges);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Face_displayVertexCount (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Face_displayVertexCount", Select3D.Face_displayVertexCount);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Polyline_displayVertexCount (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Polyline_displayVertexCount", Select3D.Polyline_displayVertexCount);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Vertex_displayVertices (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Vertex_displayVertices", Select3D.Vertex_displayVertices);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Polyline_displayVertices (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Polyline_displayVertices", Select3D.Polyline_displayVertices);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Model2D_displayEdges (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Model2D_displayEdges", Select3D.Model2D_displayEdges);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Model1D_displayEdges (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Model1D_displayEdges", Select3D.Model1D_displayEdges);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Solid_displayEdges (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Solid_displayEdges", Select3D.Solid_displayEdges);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Section_displayEdges (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Section_displayEdges", Select3D.Section_displayEdges);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_Camera_displayEdges (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.Camera_displayEdges", Select3D.Camera_displayEdges);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_select_LandPoint_displayPoints (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-select.LandPoint_displayPoints", Select3D.LandPoint_displayPoints);
    }
    return out;
  }
  ...
  float valueModifier_Interpolation_Weight (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Interpolation_Weight", Interpolation_Weight, 0, 5, 0.5);
    }
    return out;
  }
  ...
  int valueModifier_Climate_based_solar_forecast (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Climate-based solar forecast", CLIMATIC_SolarForecast, 0, 1, 1);
    }
    return out;
  }
  ...
  int valueModifier_Climate_based_temperature_forecast (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Climate-based temperature forecast", CLIMATIC_WeatherForecast, 0, 2, 1);
    }
    return out;
  }
  ...
  int valueModifier_Develop_Option (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Develop_Option", Develop_Option, 0, 11, 1);
    }
    return out;
  }
  ...
  int valueModifier_Develop_DayHour (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Develop_DayHour", Develop_DayHour, 0, 3, 1);
    }
    return out;
  }
  ...
  int valueModifier_Trend_period_hours (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Trend period hours", STUDY.TrendJoinHours, 1, 24 * 16, 1);
    }
    return out;
  }
  ...
  int valueModifier_Weighted_equal_trend (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Weighted/equal trend", STUDY.TrendJoinType, -1, 1, 2, 1);
    }
    return out;
  }
  ...
  float valueModifier_Inclination_angle (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Inclination angle", Develop_AngleInclination, 0, 90, 5, 1);
    }
    return out;
  }
  ...
  float valueModifier_Orientation_angle (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Orientation angle", Develop_AngleOrientation, 0, 360, 15, 1);
    }
    return out;
  }
  ...
  int valueModifier_Impact_Source (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Impact Source", CurrentDataSource, 0, MAXIMUM_dataID, 1);
    }
    return out;
  }
  ...
  int valueModifier_Impact_Min_50_Max (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Impact Min/50%/Max", STUDY.ImpactLayer, 0, 8, 1);
    }
    return out;
  }
  ...
  boolean valueModifier_Export_ASCII_data (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Export ASCII data", STUDY.export_info_node);
    }
    return out;
  }
  ...
  boolean valueModifier_Export_ASCII_statistics (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Export ASCII statistics", STUDY.export_info_norm);
    }
    return out;
  }
  ...
  boolean valueModifier_Export_ASCII_probabilities (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 1, 0, 0, "Export ASCII probabilities", STUDY.export_info_prob);
    }
    return out;
  }
  ...
  float valueModifier__3D_export_Scale (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-export.Scale", User3D.export_Scale, .001, 1000, -0.1);
    }
    return out;
  }
  ...
  int valueModifier__3D_export_FlipZYaxis (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-export.FlipZYaxis", User3D.export_FlipZYaxis, 0, 1, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_export_PrecisionVertex (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-export.PrecisionVertex", User3D.export_PrecisionVertex, 0, 6, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_export_PrecisionVtexture (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-export.PrecisionVtexture", User3D.export_PrecisionVtexture, 0, 6, 1);
    }
    return out;
  }
  ...
  int valueModifier__3D_export_PolyToPoly (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-export.PolyToPoly", User3D.export_PolyToPoly, 0, 1, 1);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_export_MaterialLibrary (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-export.MaterialLibrary", User3D.export_MaterialLibrary);
    }
    return out;
  }
  ...
  boolean valueModifier__3D_export_BackSides (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-export.BackSides", User3D.export_BackSides);
    }
    return out;
  }
  ...
  int valueModifier__3D_export_PaletteResolution (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "3D-export.PaletteResolution", User3D.export_PaletteResolution, 32, 2048, -2, 1);
    }
    return out;
  }
  ...
  int valueModifier_Record_SolidImpact_in_JPG (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "Record SolidImpact in JPG", allSolidImpacts.record_IMG, 0, 1, 1);
    }
    return out;
  }
  ...
  int valueModifier_Record_SolidImpact_in_PDF (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "Record SolidImpact in PDF", allSolidImpacts.record_PDF, 0, 1, 1);
    }
    return out;
  }
  ...
  int valueModifier_Record_Solar_Analysis_in_JPG (int created) {
    ...
    if (created == 0) {
      ...
      out = this.Spinner(X_control, Y_control, 0, 0, 0, "Record Solar Analysis in JPG", allSolarImpacts.record_IMG, 0, 1, 1);
    }
    return out;
  }
  int valueModifier_windRoses_resolution (int created) {
    ...
    if (created == 0) {
      ...
      out = int(this.Spinner(X_control, Y_control, 0, 1, 0, "windRoses.resolution", allWindRoses.RES, 200, 600, 100));
    }
    return out;
  }
